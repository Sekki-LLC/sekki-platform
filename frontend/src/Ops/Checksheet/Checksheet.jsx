...
const Checksheet = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      id: 1,
      type: 'ai',
      content: "Welcome to Checksheet Data Collection! I'll help you create and manage checksheets for quality control, process monitoring, and data collection. Checksheets are essential for systematic data gathering and statistical process control. What process or quality characteristic are you monitoring?",
      timestamp: new Date()
    }
  ]);
  ...
  const generateAIResponse = (userMessage) => {
    const responses = {
      'checksheet': "Checksheets are structured data collection tools that ensure consistent, systematic gathering of quality data. They should include clear measurement criteria, specification limits, and space for observations.",
      'spc': "Statistical Process Control (SPC) uses checksheet data to monitor process stability. Calculate control limits, track trends, and identify special causes of variation. Look for patterns, shifts, and outliers.",
      'capability': "Process capability indices (Cp, Cpk, Pp, Ppk) measure how well your process meets specifications. Cp measures potential capability, while Cpk accounts for process centering. Values >1.33 indicate good capability.",
      'control limits': "Control limits are calculated from process data (typically ±3 sigma from the mean). They represent the voice of the process, while specification limits represent the voice of the customer. Don't confuse them!",
      'sampling': "Good sampling ensures representative data. Use random sampling when possible, maintain consistent sample sizes, and document sampling conditions. Consider rational subgroups for meaningful analysis.",
      'trends': "Look for trends, cycles, shifts, and patterns in your data. Seven consecutive points above or below the centerline indicate a trend. Sudden shifts may indicate process changes.",
      'out of spec': "Out-of-specification measurements require immediate attention. Document the occurrence, investigate root causes, implement containment actions, and prevent recurrence through corrective measures.",
      'default': "I can help you with checksheet design, data collection methods, statistical analysis, control charts, capability studies, or quality control procedures. What specific aspect interests you?"
    };
  ...
  return (
    <div className={styles.rcaContainer}>
      ...
      <div className={styles.mainContent}>
        {/* Top Section: Checksheet Information + AI Helper - Exact match to other tools */}
            ...
            <div className={styles.chatCard}>
              ...
              <div className={styles.chatInput}>
                <input
                  ...
                  placeholder="Ask me about checksheets..."
              ...
              <div className={styles.quickActions}>
                ...
                <div className={styles.actionButtons}>
                  <button 
                    ...
                    onClick={() => handleQuickAction('What is a checksheet?')}
                  >
                    Checksheet Basics
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('How do I set up SPC?')}
                  >
                    SPC Setup
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('What are control limits?')}
                  >
                    Control Limits
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('How do I calculate capability?')}
                  >
                    Process Capability
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('How do I handle out of spec?')}
                  >
                    Out of Spec
                  </button>
                </div>
              ...
              <div className={styles.escalationToggle}>
                <label className={styles.enableToggle}>
                  <input
                    ...
                    onChange={(e) => handleQualityControlChange('escalation', {
