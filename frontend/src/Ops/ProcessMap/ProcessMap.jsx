...
const ProcessMap = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      id: 1,
      type: 'ai',
      content: "Welcome to Process Mapping! I'll help you create a comprehensive visual representation of your process. Process mapping helps identify inefficiencies, handoffs, decision points, and improvement opportunities. It's essential for understanding current state before making improvements. What process would you like to map?",
      timestamp: new Date()
    }
  ]);
  ...
  const generateAIResponse = (userMessage) => {
    const responses = {
      'process mapping': "Process mapping visualizes workflow from start to finish. Include all steps, decision points, handoffs, and delays. Use standard symbols: ovals for start/end, rectangles for activities, diamonds for decisions, and arrows for flow direction.",
      'swimlanes': "Swimlanes organize process steps by responsible party (person, department, system). They clearly show handoffs and accountability. Each lane represents a different actor in the process.",
      'value stream': "Value stream mapping focuses on value-added vs non-value-added activities. Identify waste: waiting, overproduction, defects, unnecessary motion, excess inventory, over-processing, and unused talent.",
      'decision points': "Decision points are where the process branches based on criteria. Use diamond shapes and clearly define decision criteria. Each path should be labeled with the condition that triggers it.",
      'handoffs': "Handoffs are transfer points between people, departments, or systems. They're often sources of delays, errors, and miscommunication. Document what's transferred and how.",
      'cycle time': "Cycle time is the total time from process start to finish. Lead time includes waiting time. Processing time is actual work time. Track these metrics to identify bottlenecks.",
      'waste identification': "The 8 wastes in lean: Transport, Inventory, Motion, Waiting, Overproduction, Over-processing, Defects, and Skills (TIMWOODS). Look for these in your process map.",
      'improvement': "Use process maps to identify improvement opportunities: eliminate waste, reduce handoffs, automate manual steps, parallel sequential activities, and standardize variations.",
      'default': "I can help with process mapping techniques, swimlane design, decision points, handoff identification, waste analysis, cycle time measurement, or improvement opportunities. What aspect needs guidance?"
    };
  ...
  return (
    <div className={styles.rcaContainer}>
      ...
      <div className={styles.mainContent}>
        {/* Top Section: Process Information + AI Helper - Exact match to other tools */}
            ...
            <div className={styles.chatCard}>
              ...
              <div className={styles.chatInput}>
                <input
                  ...
                  placeholder="Ask me about process mapping..."
              ...
              <div className={styles.quickActions}>
                ...
                <div className={styles.actionButtons}>
                  <button 
                    ...
                    onClick={() => handleQuickAction('How do I create a process map?')}
                  >
                    Mapping Basics
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('What are swimlanes and how do I use them?')}
                  >
                    Swimlanes
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('How do I identify decision points?')}
                  >
                    Decision Points
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('What are handoffs and why are they important?')}
                  >
                    Handoffs
                  </button>
                  <button 
                    className={styles.quickBtn}
                    onClick={() => handleQuickAction('How do I identify waste in my process?')}
                  >
